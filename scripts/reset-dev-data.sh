...
echo ""
echo "示例:"
echo "  curl -s -X POST http://localhost:10100/user/v1/auth/dev-token -H 'Content-Type: application/json' -d '{\"user_id\":1}'"
echo "  curl -s http://localhost:10400/conversation/v1/conversations -H \"Authorization: Bearer \$TOKEN\""
